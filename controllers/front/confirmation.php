...
class FirstDataIpgConfirmationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        $order_total = number_format(str_replace(array(',', ' '), array('.', ''), $cart->getOrderTotal()), 2, '.', '');

        $this->module->validateOrder($cart_id, $payment_status, $order_total, $module_name, $message, array(), $currency_id, false, $secure_key);
